...
The simulator provides a graphical interface for understanding and analyzing how processes are scheduled using a 7 state model in a time-sharing system, as well
as real time primary memory frames visualization
